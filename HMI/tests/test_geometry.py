...
class TestGeometry(unittest.TestCase):
    def test_dimensionLimits(self):
        position = Position(-10.0, 400.0, 4.0, 45.0)

        constrained = dimensionLimits(position)
    ...
    def test_coord_step_round_trip(self):
        ...
        step_position = coordToStep(position)
        restored_position = stepToCoord(step_position)
    ...
    def test_velocity_clamp(self):
        step_velocity = velocityToStep(5000.0)
