...
class CalibrationWindow(QMainWindow):
    ...
    def _loadPreviousCalibration(self):
        ...
        key = JSON_KEY
        if key in data:
            self._jogWidget._xEntry.setText(data[key]["x"])
            self._jogWidget._yEntry.setText(data[key]["y"])
            self._jogWidget._zEntry.setText(data[key]["z"])
            self._jogWidget._yawEntry.setText(data[key]["yaw"])
    ...
    def _setCalibrationPosition(self):
        ...
        """
        position = self._jogWidget.getGripperPosition()
